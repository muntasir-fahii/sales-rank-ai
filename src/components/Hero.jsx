    ...
    <section className=" lg:py-16">
      <div className=" container mx-auto max-w-6xl flex flex-col-reverse  md:flex-row items-center justify-center gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-9 h-full">
          ...
          <div className="grid lg:grid-cols-2 w-[90%] items-center">
            <img
        ...
        <div className="relative w-full md:w-1/2 flex justify-end ">
          <img
            ...
            className="w-[90%] h-[95%] "
          />
          <div className="absolute -bottom-1 -left-10 bg-white drop-shadow-lg p-4 flex flex-col gap-6 rounded-lg max-w-[60%]">
            <div className="flex justify-between">
              <h4 className="text-[32px] text-[#00245F] font-manrope font-semibold">
                721+
              </h4>
              <h4 className="text-[32px] text-[#00245F] font-manrope font-semibold">
                1000+
            ...
            <h4 className="text-xl text-[#05131D] font-poppins font-semibold">
              Growth is our priority.
            </h4>
            <p className="text-base  text-[#05131DB2]">
